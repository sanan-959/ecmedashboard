      ...
      <div className="flex-1 overflow-y-auto mt-2 px-4 text-black">
        <ul className="space-y-2">
          ...
          <li>
            <div className="w-full">
              <div className="hover:bg-gray-100 rounded">
                <button type="button" className="w-full flex items-center justify-between px-2 py-2 text-gray-700 font-semibold dark:text-gray-200 dark:hover:bg-gray-700" data-collapse-toggle="analytic-collapse6" aria-expanded="false" aria-controls="analytic-collapse" >
                  {/* Left: Icon + Text */}
                  <span className="flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="size-6" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" >
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z" />
              ...
              {/* Collapse Content */}
              <div
                id="analytic-collapse6"
                className="hidden px-6 py-2 space-y-1 text-sm text-gray-600 dark:text-gray-400">
                <ul className="list-disc text-gray-500">
                  <li>
                    <a href="/settings"
                      className="block px-2 py-1 hover:bg-gray-100 rounded dark:hover:bg-gray-700">Settings</a>
                  </li>
